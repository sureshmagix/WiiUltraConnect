...
import { normalizedPoint, encodeChunk, decodeChunk, safeFileName, validFileOffer, MAX_FILE_SIZE } from '../src/protocol.js';
...
test('file names and metadata are validated', () => {
